...
public class TradeEngineConfig {
    ...
    public Repository<OrderBook> orderBookRepository(AggregateFactory<OrderBook> orderBookAggregateFactory,
                                                     EventStore eventStore,
                                                     Cache cache,
                                                     SnapshotTriggerDefinition snapshotTriggerDefinition) {
        return new CachingEventSourcingRepository<>(orderBookAggregateFactory,
                                                    eventStore,
                                                    cache,
