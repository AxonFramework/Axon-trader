...
public class TransactionEventHandler {
    ...
    private void startTransaction(AbstractTransactionStartedEvent event, TransactionType type) {
        OrderBookView orderBookView = orderBookViewRepository.findOne(event.getOrderBookId().getIdentifier());
    ...
    private void executeTransaction(AbstractTransactionExecutedEvent event) {
        TransactionView transactionView = transactionViewRepository.findOne(event.getTransactionId().getIdentifier());
